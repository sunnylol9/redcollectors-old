...
public class CustomPlayerManager extends Manager {
    ...
    public void spawn(final ChunkCollector chunkCollector, final Location loc) {
        final org.bukkit.craftbukkit.v1_13_R2.CraftWorld w = (org.bukkit.craftbukkit.v1_13_R2.CraftWorld) loc.getWorld();
        final net.minecraft.server.v1_13_R2.WorldServer world = w.getHandle();
        final CustomNPC cp = new CustomNPC(this, world, new GameProfile(UUID.randomUUID(), "Loader-" + chunkCollector.getIdentifier()));
        final net.minecraft.server.v1_13_R2.EntityPlayer ep = (net.minecraft.server.v1_13_R2.EntityPlayer) cp.getEntityPlayer();
    ...
    public void removeNPCs(ChunkCollector chunkCollector) {
        ...
        for (final CustomPlayer cp : CustomPlayerManager.getNPCs().get(chunkCollector.getIdentifier())) {
            ...
            final net.minecraft.server.v1_13_R2.WorldServer world = ((org.bukkit.craftbukkit.v1_13_R2.CraftWorld) ep.getBukkitEntity().getLocation().getWorld()).getHandle();
