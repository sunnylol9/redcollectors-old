package warfaremc.us.chunkcollectors.sunnyt.chunkloader.v1_13_R2;
...
public class CustomNPC extends net.minecraft.server.v1_13_R2.EntityPlayer implements CustomPlayer {

    static net.minecraft.server.v1_13_R2.MinecraftServer minecraftServer;

    static {
        CustomNPC.minecraftServer = ((org.bukkit.craftbukkit.v1_13_R2.CraftServer) Bukkit.getServer()).getServer();
    }
    ...
    public CustomNPC(final Manager manager, final net.minecraft.server.v1_13_R2.WorldServer worldserver, final GameProfile gameprofile) {
        super(CustomNPC.minecraftServer, worldserver, gameprofile, new net.minecraft.server.v1_13_R2.PlayerInteractManager(worldserver));
        final net.minecraft.server.v1_13_R2.NetworkManager nm = new CustomNetworkManager();
        ...
        new BukkitRunnable() {
            public void run() {
                final net.minecraft.server.v1_13_R2.PacketPlayOutEntityDestroy packet = new net.minecraft.server.v1_13_R2.PacketPlayOutEntityDestroy(CustomNPC.this.getBukkitEntity().getEntityId());
    ...
    public void a(final net.minecraft.server.v1_13_R2.EntityLiving entityliving) {
