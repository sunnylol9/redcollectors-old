...
public class CustomPlayerManager extends Manager {
    ...
    public void spawn(final ChunkCollector chunkCollector, final Location loc) {
        final org.bukkit.craftbukkit.v1_8_R1.CraftWorld w = (org.bukkit.craftbukkit.v1_8_R1.CraftWorld) loc.getWorld();
        final net.minecraft.server.v1_8_R1.WorldServer world = w.getHandle();
        final CustomNPC cp = new CustomNPC(this, world, new GameProfile(UUID.randomUUID(), "Loader-" + chunkCollector.getIdentifier()));
        final net.minecraft.server.v1_8_R1.EntityPlayer ep = (net.minecraft.server.v1_8_R1.EntityPlayer) cp.getEntityPlayer();
    ...
    public void removeNPCs(ChunkCollector chunkCollector) {
        ...
        for (final CustomPlayer cp : CustomPlayerManager.getNPCs().get(chunkCollector.getIdentifier())) {
            ...
            final net.minecraft.server.v1_8_R1.WorldServer world = ((org.bukkit.craftbukkit.v1_8_R1.CraftWorld) ep.getBukkitEntity().getLocation().getWorld()).getHandle();
